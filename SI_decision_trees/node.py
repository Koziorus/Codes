...
class Node:
    ...
    def gini_best_score(self, y, possible_splits):
        ...
        for split in possible_splits:
            ...
            h = 0.001  # helps to not have zero in the denominator

            gini_left = 1 - (left_pos / (left + h)) ** 2 - (left_neg / (left + h)) ** 2
            gini_right = 1 - (right_pos / (right + h)) ** 2 - (right_neg / (right + h)) ** 2
            gini_gain = 1 - (left / (left + right + h)) * gini_left - (right / (left + right + h)) * gini_right
